...
public class GlobalExceptionHandler {
        ...
        @ExceptionHandler(MatchAlreadyProcessedException.class)
        public ResponseEntity<ErrorResponse> handleMatchAlreadyProcessedException(MatchAlreadyProcessedException e) {
                log.warn(e.getMessage());
                return ResponseEntity.status(HttpStatus.CONFLICT)
                                .body(ErrorResponse.of("ALREADY_MATCHED", e.getMessage()));
        }
